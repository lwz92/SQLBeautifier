...
'''
    VERSION 1.3 : Pull-in the graphical operation interface, support get the
                  source file and target folder path from button, and add the conversion log.
                  Prohibite the text box entry.
'''
...
class Sql_Convert():
    ...
    def set_init_window(self):
        self.init_window.title("sql大小写美化工具_v1.3")  # 窗口名
        ...
        self.src_data_text.config(state=DISABLED)
    ...
    def get_file(self):
        self.src_data_text.config(state=NORMAL)
